...
// Build URLs relative to whichever folder this app lives in.
...
<?php if ($isLoggedIn): ?>
    ...
    <div class="container">
        ...
        <div class="sidebar">
            ...
            <ul>
                <li><a href="<?php echo htmlspecialchars($appUrl('dashboard.php')); ?>"
                        class="<?php echo $current_page === 'dashboard.php' ? 'active' : ''; ?>">Dashboard</a></li>
                <li><a href="<?php echo htmlspecialchars($appUrl('houses.php')); ?>"
                        class="<?php echo $current_page === 'houses.php' ? 'active' : ''; ?>">Houses</a></li>
                <li><a href="<?php echo htmlspecialchars($appUrl('residents.php')); ?>"
                        class="<?php echo $current_page === 'residents.php' ? 'active' : ''; ?>">Residents</a></li>
                <li><a href="<?php echo htmlspecialchars($appUrl('payments.php')); ?>"
                        class="<?php echo $current_page === 'payments.php' ? 'active' : ''; ?>">Payments</a></li>
                <li><a href="<?php echo htmlspecialchars($appUrl('vehicles.php')); ?>"
                        class="<?php echo $current_page === 'vehicles.php' ? 'active' : ''; ?>">Vehicles</a></li>
                <li><a href="<?php echo htmlspecialchars($appUrl('maintenance.php')); ?>"
                        class="<?php echo $current_page === 'maintenance.php' ? 'active' : ''; ?>">Maintenance</a></li>
                <li><a href="<?php echo htmlspecialchars($appUrl('reports.php')); ?>"
                        class="<?php echo $current_page === 'reports.php' ? 'active' : ''; ?>">Reports</a></li>
                <li><a href="<?php echo htmlspecialchars($appUrl('audit_log.php')); ?>"
                        class="<?php echo $current_page === 'audit_log.php' ? 'active' : ''; ?>">Audit Log</a></li>
                <li><a href="<?php echo htmlspecialchars($appUrl('archive_manager.php')); ?>"
                        class="<?php echo $current_page === 'archive_manager.php' ? 'active' : ''; ?>">Archive</a></li>
                <li><a href="<?php echo htmlspecialchars($appUrl('subdivision_map.php')); ?>"
                        class="<?php echo $current_page === 'subdivision_map.php' ? 'active' : ''; ?>">Subdivision Map</a></li>
                <li><a href="<?php echo htmlspecialchars($appUrl('Login/logout.php')); ?>" class="logout-btn">Logout
